CREATE TABLE CPF_BATCH_JOBS (
  ...
  BUSINESS_APPLICATION_PARAMS     CLOB,
  PROPERTIES                      CLOB,
  WHEN_STATUS_CHANGED             TIMESTAMP       NOT NULL,
  COMPLETED_TIMESTAMP             TIMESTAMP,
  INPUT_DATA_CONTENT_TYPE         VARCHAR2(255),
  STRUCTURED_INPUT_DATA_URL       VARCHAR2(2000),
  JOB_STATUS CHARACTER            VARCHAR2(50)     NOT NULL,
  LAST_SCHEDULED_TIMESTAMP        TIMESTAMP,
  NOTIFICATION_URL                VARCHAR2(2000),
  NUM_SUBMITTED_REQUESTS          NUMBER(10)         NOT NULL,
  NUM_SUBMITTED_GROUPS            NUMBER(10)         NOT NULL,
  GROUP_SIZE                      NUMBER(5)        NOT NULL,
  COMPLETED_REQUEST_RANGE         CLOB,
  COMPLETED_GROUP_RANGE           CLOB,
  FAILED_REQUEST_RANGE            CLOB,
...
COMMENT ON COLUMN CPF_BATCH_JOBS.NUM_SUBMITTED_GROUPSS IS 'This is the number of groups which were submitted for the BATCH JOB.';
