<div>
  <h1>Map Tile by Location</h1>
  
  <table class="appDesc">
    <tr>
      <th style="width:30%;">Application Name</th>
      <td>mapTileByLocation</td>
    </tr>
    <tr>
      <th>Description</th>
      <td>The Map Tile by Id business application will return the metadata for the map tile with the specified latitude/longitude location.</td>
    </tr>
    <tr>
      <th>Version</th>
      <td>1.0.0</td>
  ...
  <table class="appDesc">
    ...
    <tr>
      <td>latitude</td>
      <td>decimal</td>
      <td>The decimal degrees of latitude to get the map tile for.</td>
      <td>Yes</td>
      <td>No</td>
      <td>Yes</td>
      <td></td>
    ...
    <tr>
      <td>longitude</td>
      <td>decimal</td>
      <td>The decimal degrees of longitude to get the map tile for.</td>
      <td>Yes</td>
      <td>No</td>
      <td>Yes</td>
      <td></td>
