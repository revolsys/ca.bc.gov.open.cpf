...
%><div>
  <h1>Business Application for User</h1>
  <p>
    The /ws/users/{userId}/{businessApplicationName} resource is the container resource for the user's resources for of a business application, with the resource name being the name of the business application.<br /> 
    For example the resource name for  business application mapTileById would be /ws/users/{userId}/mapTileById
  </p>
  <p>
    <b>URL:</b> /ws/users/{userID}/{businessApplicationName}<br />
    e.g. /ws/users/ae4a7382-85c0-46e0-986f-def6f7b9b12a/mapTileByLocation
  </p>
  <p>
  ...
  <table id="table-api">
    ...
    <tr>
      ...
      <td>String</td>
      <td>The businessApplication Name is the name of the business application.</td>
    </tr>
  </table>
</div>
