...
ALTER TABLE CPF_BATCH_JOB_FILES ADD CONSTRAINT BATCH_JOB_FILES_PK PRIMARY KEY (BATCH_JOB_ID, FILE_TYPE, SEQUENCE_NUMBER) USING INDEX TABLESPACE CPF_NDX;
ALTER TABLE CPF_BATCH_JOB_FILES ADD CONSTRAINT BATCH_JOB_FILES_JOB_FK FOREIGN KEY (BATCH_JOB_ID) REFERENCES CPF.CPF_BATCH_JOBS(BATCH_JOB_ID) ON DELETE CASCADE;

CREATE INDEX BACTH_JOB_FILES_JOB_IDX ON CPF.CPF_BATCH_JOB_FILES (BATCH_JOB_ID) TABLESPACE CPF_NDX;
