...
All plug-ins must either be available in the [Maven central repository](http://search.maven.org/).
...
[excluded](http://maven.apache.org/guides/introduction/introduction-to-optional-and-excludes-dependencies.html#Dependency_Exclusions)
...
[p:{propertyName}](http://static.springsource.org/spring/docs/3.0.x/spring-framework-reference/html/beans.html#beans-p-namespace)
or [p:{propertyName}-ref](http://static.springsource.org/spring/docs/3.0.x/spring-framework-reference/html/beans.html#beans-p-namespace)
...
The CPF can use [Well-known_text](http://en.wikipedia.org/wiki/Well-known_text) (WKT)
and [Extended WKT](http://postgis.org/documentation/manual-1.5/ch04.html#EWKB_EWKT) (EWKT) geometry
...
The plug-in The plug-in may also use [slf4j](http://www.slf4j.org/) (preferred) or
[log4j](http://logging.apache.org/log4j/) or with the following logger name sub trees.
...
* Implement a cleanup method on each bean (other than the plug-in prototype bean). This method
  ...
  implementing
  [Destruction call-backs](http://docs.spring.io/spring/docs/3.0.7.RELEASE/reference/beans.html#beans-factory-lifecycle-disposablebean)
  or [@PreDestory](http://docs.spring.io/spring/docs/3.0.7.RELEASE/reference/beans.html#beans-postconstruct-and-predestroy-annotations) annotation.
...
<div class="source">
<pre class="xml"><![CDATA[<util:map id="properties">
  <entry key="demo">
    <map>
...
5. Edit the Batch Mode Permission or Instant Mode Permission with a valid
   [Spring security expression](http://static.springsource.org/spring-security/site/docs/3.0.x/reference/el-access.html).
