...
public enum ErrorCode implements CharSequence {
 ...
 BAD_INPUT_DATA_TYPE(
  ...
  BAD_INPUT_DATA_VALUES(
    "Illegal combination of values in request input data."), /** Invalid number of batch job requests. */
  BAD_NUMBER_REQUESTS(
    "Invalid number of batch job requests."), /** Invalid response data returned from the Business Application. */
    BAD_RESPONSE_DATA(
      "Invalid response data returned from the Business Application."), /** Invalid mime type for result data. */
  BAD_RESULT_DATA_TYPE(
    "Invalid mime type for result data."), /** An unknown error occurred processing the request. */
  ERROR_PROCESSING_REQUEST("An unknown error occurred processing the request."), /** Unable to read batch job input data. */
  INPUT_DATA_UNREADABLE(
    "Unable to read batch job input data."), /** A supplied request or job parameter has an invalid type or value. */
  INVALID_PARAMETER_VALUE(
    "A supplied request or job parameter has an invalid type or value."), /** A required request or job parameter is missing. */
  MISSING_REQUIRED_PARAMETER(
    "A required request or job parameter is missing."), /** A temporary exception that can be recovered from. */
  RECOVERABLE_EXCEPTION(
    "A temporary exception that can be recovered from."), /** Too many batch job requests for this business application. */
  TOO_MANY_REQUESTS(
