CREATE TABLE CPF_BATCH_JOB_STATUS_CHANGE (
  ...
  CONSTRAINT BATCH_JOB_STATUS_CHANGE_PK PRIMARY KEY (BATCH_JOB_STATUS_CHANGE_ID) USING INDEX TABLESPACE CPF_NDX,
...
CREATE INDEX CPF_BJSC_BJ_FK_I ON CPF.CPF_BATCH_JOB_STATUS_CHANGE (BATCH_JOB_ID) TABLESPACE CPF_NDX;
