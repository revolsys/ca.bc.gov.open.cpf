...
CREATE TABLE CPF.CPF_BATCH_JOB_RESULTS
 ...
 ,BATCH_JOB_REQUEST_ID NUMERIC(19,0)
 ,DOWNLOAD_TIMESTAMP TIMESTAMP
 ,REQUEST_SEQUENCE_NUMBER NUMERIC(19,0)
 ,RESULT_DATA OID
...
CREATE TABLE CPF.CPF_BATCH_JOB_REQUESTS
 (BATCH_JOB_REQUEST_ID NUMERIC(19,0) NOT NULL
 ,BATCH_JOB_ID NUMERIC(19,0) NOT NULL
 ,BATCH_JOB_RESULT_ID NUMERIC(19,0)
 ,REQUEST_SEQUENCE_NUMBER NUMERIC(19,0) NOT NULL
 ,COMPLETED_IND NUMERIC(1,0) NOT NULL
 ,STARTED_IND NUMERIC(1,0) NOT NULL
 ,ERROR_CODE VARCHAR(255)
 ,ERROR_DEBUG_MESSAGE VARCHAR(4000)
...
CREATE TABLE CPF.CPF_BATCH_JOBS
 (BATCH_JOB_ID NUMERIC(19,0) NOT NULL
 ,BUSINESS_APPLICATION_NAME VARCHAR(255) NOT NULL
 ,BUSINESS_APPLICATION_VERSION VARCHAR(255) NOT NULL
 ,JOB_STATUS VARCHAR(50) NOT NULL
 ,NUM_COMPLETED_REQUESTS NUMERIC(19,0) NOT NULL
 ,NUM_EXECUTING_REQUESTS NUMERIC(19,0) NOT NULL
