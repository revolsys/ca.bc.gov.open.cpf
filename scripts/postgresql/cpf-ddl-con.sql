...
ALTER TABLE CPF.CPF_BATCH_JOB_REQUESTS
 ADD CONSTRAINT CPF_BJRQ_PK PRIMARY KEY 
...
ALTER TABLE CPF.CPF_BATCH_JOB_REQUESTS ADD CONSTRAINT
 CPF_BJRQ_CPF_BJ_FK FOREIGN KEY 
  (BATCH_JOB_ID) REFERENCES CPF.CPF_BATCH_JOBS
  (BATCH_JOB_ID);
