...
public interface BatchJobResult extends Common {
  ...
  public static final List<String> ALL_EXCEPT_BLOB = Arrays.asList(BATCH_JOB_ID,
    BATCH_JOB_RESULT_TYPE, SEQUENCE_NUMBER, RESULT_DATA_CONTENT_TYPE, RESULT_DATA_URL, WHEN_CREATED,
    DOWNLOAD_TIMESTAMP);
